...
class KissRpc {
    ...
    static createErrorResponse(id, errorCode, errorReason) {
    ...
    handleMessage(message, appData) {
        switch (message.type) {
            ...
            case MessageType.Notification:
                ...
                if (!handler)
                    return this.callToTransport(KissRpc.createErrorResponse(message.type === MessageType.Request ? message.id : -1, exports.KISS_RPC_ERRORS.METHOD_NOT_FOUND.code, exports.KISS_RPC_ERRORS.METHOD_NOT_FOUND.message));
                try {
                    ...
                    if (handler.isAsync) {
                        result.then((res) => {
                            ...
                            this.callToTransport(KissRpc.createErrorResponse(message.id, exports.KISS_RPC_ERRORS.INTERNAL_ERROR.code, exports.KISS_RPC_ERRORS.INTERNAL_ERROR.message), appData);
                        });
                    }
                    else {
            ...
            case MessageType.ErrorResponse:
                ...
                if (pendingRequest) {
                    ...
                    if (message.type === MessageType.Response) {
                        ...
                        pendingRequest.reject(new KissRpcError(message.error.code, message.error.message, message.id));
                    }
                }
        }
    }
